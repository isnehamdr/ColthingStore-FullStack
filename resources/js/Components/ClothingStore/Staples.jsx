...
const Staples = () => {
	...
	return (
		<section className="py-8 md:py-16 lg:py-20 px-4 sm:px-6 md:px-8"
			style={
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
				<div className="md:col-span-2">
					...
					loading ? (
						<div className="grid grid-cols-2 gap-3 md:grid-cols-2">
							...
							[...Array(4)].map((_, index) => (
								<div key={index}
									className="bg-gray-100 animate-pulse h-72 md:h-[75vh]"/>
							))
						} </div>
					) : (
						<>
				...
				<div className="group relative overflow-hidden mt-4 md:mt-0">
					<img src="/images/t5.avif" alt="Latest Classic Arrivals" className="w-full h-64 md:h-full object-cover transition-transform duration-700 group-hover:scale-105"/>
