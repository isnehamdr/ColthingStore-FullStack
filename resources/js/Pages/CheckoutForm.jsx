...
// import { CheckCircle, Shield, Truck, CreditCard, User, MapPin, Phone } from 'lucide-react';
...
//         setSuccess(`Order placed successfully! Your order number is: ${orderNumber}`);
//         clearCart();
//         setFormData({
//           email: '', 
//           firstName: '', 
...
//               formErrors.cardNumber ? 'border-red-500 bg-red-50' : 'border-gray-300'
//             }`}
...
//               onChange={handleInputChange}
//               className={`block w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors ${
//                 formErrors.expiryDate ? 'border-red-500 bg-red-50' : 'border-gray-300'
//               }`}
//               placeholder="MM/YY"
//               maxLength={5}
//               required
...
//               onChange={handleInputChange}
//               className={`block w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors ${
//                 formErrors.cvv ? 'border-red-500 bg-red-50' : 'border-gray-300'
//               }`}
//               placeholder="123"
//               maxLength={4}
//               required
...
//             onChange={handleInputChange}
//             className={`block w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors ${
//               formErrors.nameOnCard ? 'border-red-500 bg-red-50' : 'border-gray-300'
//             }`}
//             placeholder="John Doe"
//             required
//           />
//           {formErrors.nameOnCard && (
//             <p className="mt-2 text-sm text-red-600">{formErrors.nameOnCard}</p>
//           )}
//         </div>
//       </div>
//     </div>
...
//             <a 
//               href="/" 
//               className="inline-block bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-3 rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-200 transform hover:-translate-y-0.5 shadow-md"
//             >
//               Continue Shopping
//             </a>
//           </div>
...
//                     className={`w-full mt-6 bg-gradient-to-r from-blue-600 to-purple-600 border border-transparent rounded-lg shadow-sm py-4 px-4 text-base font-semibold text-white hover:from-blue-700 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 transform hover:-translate-y-0.5 ${
//                       (loading || cart.length === 0) ? 'opacity-50 cursor-not-allowed' : 'hover:shadow-lg'
//                     }`}
//                   >
//                     {loading ? (
