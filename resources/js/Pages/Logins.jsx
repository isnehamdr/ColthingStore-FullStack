        ...
        <div className="w-full max-w-md mx-auto lg:mx-0 lg:max-w-none">
          <div className="bg-white rounded-2xl shadow-lg p-8 lg:p-10">
            ...
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-gray-900 text-white py-3 px-4 rounded-lg hover:bg-gray-800 focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-200 font-medium text-sm lg:text-base"
              >
                Sign in
              </button>
            </form>
